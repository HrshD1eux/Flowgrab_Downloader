  ...
  const screenshots = [
    {
      ...
      badge: "Light UI",
      desc: "Clean light theme interface with instant URL analysis, stream selectors, and clipboard auto-capture.",
    ...
    },
    {
      ...
      badge: "Task Manager",
      desc: "Live transfer speeds, estimated remaining time (ETA), progress tracking, and Show-in-Folder actions.",
      src: "/screenshots/screenshot2.png",
    },
    {
      id: 3,
      title: "Engine Updates",
      badge: "1-Click Updater",
      desc: "In-app background updater for Flowgrab desktop release, yt-dlp core, and FFmpeg muxing engine.",
    ...
    },
    {
      ...
      desc: "Configure default download directories, audio/video formats, auto-reset, and deep-link capture.",
    ...
    },
    {
      ...
      badge: "Dark Theme",
      desc: "Sleek, high-contrast dark theme mode engineered for night sessions and eye comfort.",
